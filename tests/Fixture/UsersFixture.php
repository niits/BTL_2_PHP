...
class UsersFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'role_id' => ['type' => 'string', 'length' => 20, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'created' => '2019-06-21 10:14:58',
                'modified' => '2019-06-21 10:14:58'
            ],
        ];
        parent::init();
    }
